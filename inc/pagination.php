...
if ( ! function_exists( 'basic_name_pagination' ) ) {
    /**
     ...
     */
    function basic_name_pagination( $args = array(), $class = 'pagination' ) {
        ...
        $args = wp_parse_args(
            ...
            array(
                'mid_size'           => 2,
                'prev_next'          => true,
                'prev_text'          => _x( '&laquo;', 'previous set of posts', 'basic_name' ),
                'next_text'          => _x( '&raquo;', 'next set of posts', 'basic_name' ),
                'current'            => max( 1, get_query_var( 'paged' ) ),
                'screen_reader_text' => __( 'Posts navigation', 'basic_name' ),
            )
        );
